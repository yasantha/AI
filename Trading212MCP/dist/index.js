    ...
    server.setRequestHandler(CallToolRequestSchema, async (request) => {
        ...
        switch (name) {
            ...
            case "get_history_dividends":
                return jsonContent(await client.get("/api/v0/equity/history/dividends", {
            ...
            case "get_history_orders":
                return jsonContent(await client.get("/api/v0/equity/history/orders", {
                    cursor: getStringArg(args, "cursor"),
                    ticker: getStringArg(args, "ticker"),
                    limit: getNumberArg(args, "limit")
                }));
            case "get_history_transactions":
                return jsonContent(await client.get("/api/v0/equity/history/transactions", {
                    cursor: getStringArg(args, "cursor"),
            ...
            case "get_metadata_instruments":
                return jsonContent(await client.get("/api/v0/equity/metadata/instruments"));
            case "get_orders":
                return jsonContent(await client.get("/api/v0/equity/orders"));
            case "get_order_by_id":
                return jsonContent(await client.get(`/api/v0/equity/orders/${getNumberArg(args, "id") ?? 0}`));
            case "get_pies":
                return jsonContent(await client.get("/api/v0/equity/pies"));
            case "get_pie_by_id":
                return jsonContent(await client.get(`/api/v0/equity/pies/${getNumberArg(args, "id") ?? 0}`));
            case "get_positions":
                return jsonContent(await client.get("/api/v0/equity/positions", {
                    ticker: getStringArg(args, "ticker")
                }));
            default:
